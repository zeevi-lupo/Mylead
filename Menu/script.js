...
// --- MESIN PERANGKINGAN (LEADERBOARD) ---
function renderLeaderboard(data) {
    ...
    if(arrayRanking.length === 0) {
        tbody.innerHTML = '<tr><td colspan="4" class="text-center text-muted py-4">Belum ada lead yang approve.</td></tr>';
        return;
    }
    ...
    arrayRanking.forEach((member, index) => {
        ...
        tbody.innerHTML += `
            <tr>
                ...
                <td style="font-weight:600;">${member.leads} Conversions</td>
                <td class="text-green" style="font-weight:700; font-size:16px;">$ ${member.pendapatan.toFixed(2)}</td>
            </tr>
        `;
    });
}
